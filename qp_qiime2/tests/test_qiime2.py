...
from qp_qiime2.qp_qiime2 import (
    ...
    BETA_DIVERSITY_METRICS, BETA_DIVERSITY_METRICS_PHYLOGENETIC, call_qiime2,
...
class qiime2Tests(PluginTestCase):
    ...
    def test_not_analysis_artifact(self):
        params = {
            ...
            'depth will be not be included in the resulting table. '
            '(sampling_depth)': '2',
            ...
            'table. (sampling_depth)': 'sampling_depth',
    ...
    def test_filter_features(self):
        params = {
            ...
            '[table]': '8',
            'qp-hide-metadata': 'Feature metadata used with `where` parameter '
            'when selecting features to retain, or with `exclude_ids` when '
            'selecting features to discard. (metadata)',
